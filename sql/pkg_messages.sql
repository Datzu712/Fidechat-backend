...
CREATE OR REPLACE PACKAGE BODY PKG_MESSAGES AS
    ...
    BEGIN
        INSERT INTO MESSAGE (ID, CONTENT, AUTHOR_ID, CHANNEL_ID)
        VALUES (P_ID, P_CONTENT, P_AUTHOR_ID, P_CHANNEL_ID);
    EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-22001, 'Error creating MESSAGE: ' || SQLERRM);
    END CREATE_MESSAGE;
